...
<section class="section apply">
  <div class="container">
    <div class="row">
      ...
      <form class="apply-form form-horizontal" method="post" action="<?php echo base_url(); ?>HomeController/talentRegistrationData" enctype="multipart/form-data">
        <div class="row">
          <div class="form-block">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="name" name="first_name" placeholder="John" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="sexuality" placeholder="Stright, Gay, Bisexual, Lesbian..." required>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="phone_number" placeholder="123456789" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="phone" name="residental_address" placeholder="123, street, abc, london" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="experience" placeholder="3 years">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="alternative_number" placeholder="123456789">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="fb_link" placeholder="https://www.facebook.com/username">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="twitter_link" placeholder="https://www.twitter.com/username">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="insta_link" placeholder="https://www.instagram.com/username/">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="city" class="col-sm-4 control-label">Picture</label>
                <div class="col-sm-8">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="city" class="col-sm-4 control-label">CV</label>
                <div class="col-sm-8">
                  <input type="file" class="form-control" name="cv" id="picture">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="user_name" placeholder="JohnDoe123" required>
                </div>
              </div>
            </div>
